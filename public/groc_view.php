<?php
include ("index.php");
$groc="select * From list where Category='FruitGrocery'";
$grec=mysqli_query($dbconnect,$groc);
?>
<html>
<head>
...
<p style="font-size: 17px; font-family:Minion Pro Med;"><a href="len_view.php"><b>1.Lentils</b></a></p>
...
<tr style="color:#1A446C"><td colspan="2"><center>Fruits & Grocery</center></td></tr>
<th style="color:#1A446C"><b>Item</b></th>
<th style="color:#1A446C"><b>Quantity</th>
</tr>

<?php
while($list=mysqli_fetch_assoc($grec)){
	echo "<tr>";
	//echo "<td>".$list['SN']."</td>";
