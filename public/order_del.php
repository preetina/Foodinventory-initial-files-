...
<p style="text-align: left; font-family: Lucida Calligraphy; font-size:18px; text-align:center;"><b>Delete Order!</b></p>
<table width="600px" border="2" cellpadding="2" cellspacing="2" align="center">
	...
	while($row=mysqli_fetch_array($record))
	{
		...
		echo "<td><a href=deleteorder.php?id=".$row['Id']."><input type=Submit value=Delete></a></td>";
