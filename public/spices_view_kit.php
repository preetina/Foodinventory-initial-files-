...
$spices="select * From list where Category='Spices'";
$srec=mysqli_query($dbconnect,$spices);
?>
<html>
<head>
...
<tr style="color:#1A446C"><td colspan="4"><center>Spices</center></td></tr>
...
<?php
while($list=mysqli_fetch_assoc($srec)){
	echo "<tr>";
	//echo "<td>".$list['SN']."</td>";
